/*
 * Version 2.4, Date 02 June 2023
 * 
 * This StressTest program requires at least Java 8. If your Java version is out of date, 
 * please update to Java 8 or later Java version.
 * 
...
public class StressTest {
	...
	public static void main(String[] args) {
		...
		Random random = new Random(20230602);
	...
	private static void createPlayer(Vector<StressTestPlayer> l) {
		...
		synchronized(l) { 
			if (!shutdownInProgress) {
				...
				System.out.println("Wait no more than 5 seconds when creating a new player.");
	...
	private static void killPlayer(Vector<StressTestPlayer> l, Random r) {
		...
		synchronized(l) { 
			if (!shutdownInProgress) {
				System.out.println("Killing player " + player.playerid);
				System.out.println("Wait no more than 5 seconds when killing a player.");
				player.extprocess.destroyForcibly();
				l.remove(player);
